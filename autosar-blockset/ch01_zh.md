...
- [1.1 AUTOSAR Blockset 产品描述](#11-autosar-blockset-产品描述)
- [1.2 什么是 AUTOSAR？](#12-什么是-autosar)
- [1.3 AUTOSAR 标准](#13-autosar-标准)
- [1.4 AUTOSAR Classic 与 Adaptive 平台对比](#14-autosar-classic-与-adaptive-平台对比)
- [1.5 在 Simulink 中建模 AUTOSAR Classic 组件及元素](#15-在-simulink-中建模-autosar-classic-组件及元素)
- [1.6 在 Simulink 中建模 AUTOSAR Adaptive 组件及元素](#16-在-simulink-中建模-autosar-adaptive-组件及元素)
- [1.7 AUTOSAR 软件组件与组合](#17-autosar-软件组件与组合)
- [1.8 AUTOSAR 工作流](#18-autosar-工作流)
- [1.9 AUTOSAR 工作流示例](#19-autosar-工作流示例)
- [1.10 开发 AUTOSAR 软件组件模型](#110-开发-autosar-软件组件模型)
- [1.11 创建表示 AUTOSAR 软件组件行为的算法模型内容](#111-创建表示-autosar-软件组件行为的算法模型内容)
- [1.12 为 Simulink 建模环境配置 AUTOSAR 软件组件元素](#112-为-simulink-建模环境配置-autosar-软件组件元素)
- [1.13 仿真并可选生成 AUTOSAR 软件组件代码（需要 Embedded Coder）](#113-仿真并可选生成-autosar-软件组件代码需要-embedded-coder)
- [1.14 开发 AUTOSAR Adaptive 软件组件模型](#114-开发-autosar-adaptive-软件组件模型)
- [1.15 创建表示 AUTOSAR Adaptive 软件组件行为的算法模型内容](#115-创建表示-autosar-adaptive-软件组件行为的算法模型内容)
- [1.16 为 Simulink 建模环境配置 AUTOSAR Adaptive 软件组件元素](#116-为-simulink-建模环境配置-autosar-adaptive-软件组件元素)
- [1.17 仿真 AUTOSAR Adaptive 软件组件并可选生成代码（需要 Embedded Coder）](#117-仿真-autosar-adaptive-软件组件并可选生成代码需要-embedded-coder)
- [1.18 开发 AUTOSAR 软件架构模型](#118-开发-autosar-软件架构模型)
- [1.19 创建 AUTOSAR 软件架构模型](#119-创建-autosar-软件架构模型)
- [1.20 添加 AUTOSAR 组合与组件并链接组件实现](#120-添加-autosar-组合与组件并链接组件实现)
- [1.21 在 AUTOSAR 架构中仿真组件](#121-在-autosar-架构中仿真组件)
- [1.22 可选：生成并打包组合 ARXML 及组件代码（需要 Embedded Coder）](#122-可选生成并打包组合-arxml-及组件代码需要-embedded-coder)
...
![图 1.1 AUTOSAR Blockset 产品概览](images/ch01/p019-000.png)
*图 1.1 – AUTOSAR Blockset 产品概览*
...
> 另请参见：[AUTOSAR Classic 与 Adaptive 平台对比](#14-autosar-classic-与-adaptive-平台对比)

### 1.2.2 在 Simulink 中开发 AUTOSAR 系统
...
![图 1.2 AUTOSAR 往返集成工作流](images/ch01/p021-000.png)
*图 1.2 – AUTOSAR 往返集成工作流*
...
> 相关示例：
> - [AUTOSAR Classic 与 Adaptive 平台对比](#14-autosar-classic-与-adaptive-平台对比)
> - [在 Simulink 中建模 AUTOSAR Classic 组件及元素](#15-在-simulink-中建模-autosar-classic-组件及元素)
> - [在 Simulink 中建模 AUTOSAR Adaptive 组件及元素](#16-在-simulink-中建模-autosar-adaptive-组件及元素)
> - [开发 AUTOSAR 软件组件模型](#110-开发-autosar-软件组件模型)
> - [开发 AUTOSAR Adaptive 软件组件模型](#114-开发-autosar-adaptive-软件组件模型)
> - [开发 AUTOSAR 软件架构模型](#118-开发-autosar-软件架构模型)
...
![图 1.3 AUTOSAR 分层软件架构](images/ch01/p028_arch.jpg)
...
- **架构**——分层软件架构将应用软件与执行平台解耦。AUTOSAR 软件组件与运行时环境之间的标准接口允许在车辆的电子控制单元（ECU）拓扑中复用或重定位组件。
  ...
  该标准定义了称为 AUTOSAR 平台的软件架构变体：Classic Platform（经典平台）和 Adaptive Platform（自适应平台）。更多信息请参见 [AUTOSAR Classic 与 Adaptive 平台对比](#14-autosar-classic-与-adaptive-平台对比)。

- **方法论**——配置描述文件定义 ECU 之间共享的系统信息、特定 ECU 独有的系统信息以及特定 ECU 的基础软件信息。
- **基础（Foundation）**——AUTOSAR 平台之间共享的需求和规范，支持平台互操作性。
- **应用接口（Application Interfaces）**——通过为典型汽车应用指定接口并指定软件各层之间的接口，提供标准化的交换格式。
...
![图 1.4 AUTOSAR Classic Platform 架构（ECU 内部视图）](images/ch01/p046-000.png)
*图 1.4 – AUTOSAR Classic Platform 嵌入式控制单元（ECU）架构*
...
![图 1.5 AUTOSAR Classic Platform 虚拟功能总线（VFB）](images/ch01/p050-000.png)
*图 1.5 – AUTOSAR Classic Platform 虚拟功能总线与部署映射*
...
![图 1.6 AUTOSAR Adaptive Platform 架构](images/ch01/p054-000.png)
*图 1.6 – AUTOSAR Adaptive Platform 架构（ARA 运行时环境）*
...
![图 1.7 AUTOSAR Adaptive Platform 部署映射](images/ch01/p056-000.png)
*图 1.7 – AUTOSAR Adaptive Platform 虚拟机部署映射*
...
配置 AUTOSAR Classic Platform 后，您可以从 AUTOSAR 组件快速启动窗口中选择组件类型。

![图 1.8 AUTOSAR 组件快速启动 — 选择组件类型](images/ch01/p059-000.png)
*图 1.8 – AUTOSAR Component Quick Start 工具*

AUTOSAR 软件组件是 AUTOSAR 软件的可复用构建块。AUTOSAR 软件组件连接到 AUTOSAR 运行时环境（RTE），以与 AUTOSAR 软件架构中基础软件（BSW）层的其他 AUTOSAR 软件组件和软件进行通信。在 Simulink 中，您使用 Simulink 模型组件（例如从组合模型引用的 Model 模块）来表示 AUTOSAR 软件组件。
...
![图 1.9 AUTOSAR Classic Platform 组件类型概览](images/ch01/p060-000.png)
*图 1.9 – AUTOSAR Classic Platform 软件组件类型*
...
![图 1.10 AUTOSAR 端口与接口配置](images/ch01/p062-000.png)
*图 1.10 – AUTOSAR Classic 软件组件的端口与接口类型*
...
AUTOSAR Dictionary 以树形格式显示已映射的 AUTOSAR 组件及其元素、通信接口、计算方法（CompuMethods）、软件地址方法（SwAddrMethods）和 XML 选项。使用该树选择 AUTOSAR 元素并配置其属性。导出的 ARXML 描述以及可能生成的符合 AUTOSAR 标准的 C 代码将反映您修改的属性。

![图 1.11 AUTOSAR Dictionary 配置视图](images/ch01/p063-000.png)
*图 1.11 – AUTOSAR Dictionary 树形配置视图*

更多信息请参见 "配置 AUTOSAR 元素和属性"（第4-8页）。

### 1.5.3 配置和生成 AUTOSAR 代码
...
您还可以配置 AUTOSAR 代码生成，以根据特定的 AUTOSAR 模式版本生成 C 代码和 ARXML 描述，指定 XML 选项来源、AUTOSAR 包路径和平台类型，并修改默认的 AUTOSAR 代码生成选项。

![图 1.12 AUTOSAR Classic 代码生成选项](images/ch01/p065-000.png)
*图 1.12 – AUTOSAR Classic Platform 代码生成配置选项*
...
### 1.6.2 创建 AUTOSAR Adaptive 软件组件
...
![图 1.13 AUTOSAR Adaptive 端口与接口配置](images/ch01/p066-000.png)
*图 1.13 – AUTOSAR Adaptive 软件组件的端口与接口*
...
![图 1.14 AUTOSAR Adaptive 清单文件与可执行文件生成](images/ch01/p068-000.png)
*图 1.14 – AUTOSAR Adaptive 模型生成的清单文件与可执行文件*
...
您还可以配置 AUTOSAR 代码生成，以根据特定的 AUTOSAR 模式版本生成 C++ 代码和 ARXML 描述，指定 XML 选项、AUTOSAR 包路径，并修改默认的 AUTOSAR 代码生成选项。
...
![油门位置控制组合](images/ch01/p043-000.png)
*图 1.7 – 油门位置控制组合*
...
![图 1.15 油门位置控制组合](images/ch01/p071-000.png)
*图 1.15 – 油门位置控制的 AUTOSAR 软件组件组合*
...
本教程假设您熟悉 AUTOSAR 标准和 Simulink 的基础知识。本教程的代码生成部分假设您具备 Embedded Coder 的基础知识。有关 AUTOSAR 标准的更多信息，请参见 [什么是 AUTOSAR？](#12-什么是-autosar)。
...
![图 1.16 示例模型文件列表](images/ch01/p072-000.png)
*图 1.16 – AUTOSAR 软件组件教程示例模型*
...
![图 1.17 教程学习目标](images/ch01/p073-000.png)
*图 1.17 – 开发 AUTOSAR 软件组件模型的学习目标*

> 继续教程请参见：[创建表示 AUTOSAR 软件组件行为的算法模型内容](#111-创建表示-autosar-软件组件行为的算法模型内容)
...
2. 探索模型组件。该模型包括：
   ...
   ![图 1.18 autosar_swc 示例模型](images/ch01/p074-000.png)
   *图 1.18 – autosar_swc 示例模型组件*
...
3. 探索模型配置。
   ...
   ![图 1.19 模型配置详细视图](images/ch01/p075-000.png)
   *图 1.19 – autosar_swc 模型配置参数详情*
...
4. 运行 AUTOSAR Component Quick Start 工具。从 Apps 选项卡打开 AUTOSAR Component Designer 应用程序。当您为配置了 AUTOSAR 系统目标文件的未映射模型打开该应用程序时，AUTOSAR Component Quick Start 工具会运行。
   ...
   ![图 1.20 AUTOSAR Component Quick Start 工具启动](images/ch01/p076-000.png)
   *图 1.20 – AUTOSAR Component Quick Start — 初始配置向导*
...
5. 推进 AUTOSAR Component Quick Start 工具的各个步骤。每一步都会提示您输入工具用于为 Simulink 环境配置 AUTOSAR 软件组件的信息。
   ...
   ![图 1.21 AUTOSAR Code 透视图与 Code Mappings Editor](images/ch01/p077-000.png)
   *图 1.21 – AUTOSAR Code 透视图：模型与 Code Mappings Editor*
...
3. 选择模型 Inport `In1_1s`。选择该 Inport 会高亮显示模型中的相应元素。该 Inport 映射到 AUTOSAR 端口 `In1_1s` 和数据元素 `In1_1s`，数据访问模式为 `ImplicitReceive`。
   ...
   ![图 1.22 Code Mappings Editor Inports 选项卡](images/ch01/p078-000.png)
   *图 1.22 – Code Mappings Editor — Inports 选项卡与属性配置*

4. 使用已映射模型元素的属性设置修改额外的映射属性。对于本教程，修改 Inport `In1_1s` 的通信属性。点击属性图标并：

   - 将 AliveTimeout 设置为 30
   - 选中 HandleNeverReceived
   - 将 InitValue 设置为 1

   ![图 1.23 通信属性详细配置](images/ch01/p078-002.png)
   *图 1.23 – Inport 通信属性配置（AliveTimeout、HandleNeverReceived、InitValue）*

5. 保存模型。

### 1.12.3 从 AUTOSAR 标准视角配置 AUTOSAR 软件组件元素
...
3. 使用 AUTOSAR Dictionary 进一步自定义组件配置。在 ReceiverPorts 视图中，选择端口 `In1_1s`，即 Simulink Inport 映射到的 AUTOSAR 接收方端口。会显示一个属性面板，显示该元素的属性设置。
   ...
   ![图 1.24 AUTOSAR Dictionary 配置界面](images/ch01/p080-000.png)
   *图 1.24 – AUTOSAR Dictionary — ReceiverPorts 视图与属性面板*
...
在为 Simulink 环境配置 AUTOSAR 软件组件模型之后，仿真您在 [为 Simulink 建模环境配置 AUTOSAR 软件组件元素](#112-为-simulink-建模环境配置-autosar-软件组件元素) 中配置的模型 `my_autosar_swc`。
...
3. 在代码生成报告中，查看生成的代码。在您当前的 MATLAB 文件夹中，`my_autosar_swc_autosar_rtw` 文件夹包含下表列出的主要文件。
   ...
   ![图 1.25 代码生成报告](images/ch01/p081-000.png)
   *图 1.25 – AUTOSAR Classic 代码生成报告*
...
4. 打开并查看代码接口报告。有关代码接口报告的更多信息，请参见 "Analyze Generated Data Code Interface Report"（Embedded Coder）。代码接口报告会为配置了 AUTOSAR 系统目标文件的模型自动生成。代码接口信息被捕获在生成的 ARXML 文件中。运行时环境生成器使用 ARXML 描述将代码接口接入 AUTOSAR 运行时环境。
   ...
   ![图 1.26 代码接口报告详情](images/ch01/p081-002.png)
   *图 1.26 – 生成的代码接口报告*
...
5. 使用 Code 透视图中的 Code 面板检查您所做的配置更改是否出现在生成的代码中。要打开 Code 面板，在 AUTOSAR 选项卡上点击 View Code。Code 面板在模型右侧打开。在搜索字段中，键入 `In1_1s_SS1`，即 AUTOSAR 软件组件端口 `In1_1s` 的新名称。然后点击箭头按钮前进到 ARXML 文件 `my_autosar_swc_component.arxml` 中该名称的实例。验证您为 AUTOSAR 软件组件端口修改的通信属性设置是否正确显示。
   ...
   ![图 1.27 Code 面板 ARXML 搜索](images/ch01/p083-000.png)
   *图 1.27 – Code 面板中搜索 AUTOSAR 组件端口名称*
...
![图 1.28 LaneGuidance 示例模型](images/ch01/p084-000.png)
*图 1.28 – AUTOSAR Adaptive 教程 — LaneGuidance 示例模型*
...
> 继续教程请参见：[创建表示 AUTOSAR Adaptive 软件组件行为的算法模型内容](#115-创建表示-autosar-adaptive-软件组件行为的算法模型内容)
...
2. 探索模型。它由一个子系统 `LaneGuidanceAlgorithm` 组成。该子系统有六个 Inport，代表 AUTOSAR Adaptive 软件组件的需求端口：`leftLaneDistance`、`leftTurnIndicator`、`leftCarInBlindSpot`、`rightLaneDistance`、`rightTurnIndicator` 和 `rightCarInBlindSpot`。两个 Outport 代表提供端口：`leftHazardIndicator` 和 `rightHazardIndicator`。
   ...
   ![图 1.29 LaneGuidance 算法子系统](images/ch01/p084-002.png)
   *图 1.29 – LaneGuidance 模型的算法子系统与 Event Receive/Send 模块*
...
### 1.16.3 从 AUTOSAR 标准视角配置 AUTOSAR Adaptive 软件组件元素
...
在为 Simulink 环境配置 AUTOSAR Adaptive 软件组件模型之后，仿真您在 [为 Simulink 建模环境配置 AUTOSAR Adaptive 软件组件元素](#116-为-simulink-建模环境配置-autosar-adaptive-软件组件元素) 中配置的模型 `my_autosar_LaneGuidance`。
...
> 继续教程请参见：[创建 AUTOSAR 软件架构模型](#119-创建-autosar-软件架构模型)
